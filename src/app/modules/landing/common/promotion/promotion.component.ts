...
export class PromotionModalComponent implements OnInit, OnDestroy {
    ...
    async uploadImageAndPatchForm(): Promise<void> {
        if (this.selectedImage) {
            try {
                ...
                const imageUrl = await this._portalService.uploadFileWithoutId(this.selectedImage, 'Promotion');
    ...
    async save(): Promise<void> {
        ...
        if (this.form.valid) {
            ...
            if (this.single === 'add') {
                this._portalService.createPromotion(formData)
                    .then((res) => {
                ...
                this._portalService.updatePromotion(this.single.id, formData)
                    .then((res: any) => {
