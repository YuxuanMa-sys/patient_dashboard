...
export class BookingSuccessModalComponent implements OnInit, OnDestroy, AfterViewInit {
    note$: Observable<any>;
    single: any;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<BookingSuccessModalComponent>,
    ...
    openDialog(data: any): void {
        const dialogRef = this._matDialog.open(BookingSuccessModalComponent, {
            autoFocus: false,
            data: cloneDeep(data)
        });
    ...
    close() {
        this._router.navigateByUrl('/patient-portal');
