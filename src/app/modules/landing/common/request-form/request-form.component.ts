...
export class RequestFormModalComponent implements OnInit, OnDestroy, AfterViewInit {
    note$: Observable<any>;
    single: any;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<RequestFormModalComponent>,
    ...
    openDialog(data: any): void {
        const dialogRef = this._matDialog.open(RequestFormModalComponent, {
            autoFocus: false,
            data: cloneDeep(data)
        });
